    ...
    <main className="min-h-screen bg-slate-900 flex flex-col items-center justify-center p-4 text-white">
      <div className="max-w-md w-full space-y-8 bg-slate-800 p-8 rounded-xl shadow-2xl border border-slate-700">
        <div className="text-center">
          ...
          <p className="text-slate-400">Sign in to your AI Coach account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 px-4 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg transition-colors ring-2 ring-transparent ring-offset-2 ring-offset-slate-800 focus:outline-none focus:ring-red-500 disabled:opacity-50"
          >
